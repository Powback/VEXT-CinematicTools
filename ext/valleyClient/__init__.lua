...
ve_valleynight = require "valleynight"
ve_valleynighti = require "valleynighti"
ve_valleymorning = require "valleymorning"
ve_NV = require "NV"
...
function CinematicToolsClient:RegisterVars()
	...
	self.m_valleynight = json.decode(ve_valleynight:GetPreset())
	self.m_valleynighti = json.decode(ve_valleynighti:GetPreset())
	self.m_valleymorning = json.decode(ve_valleymorning:GetPreset())
	self.m_NV = json.decode(ve_NV:GetPreset())
	self.m_Presets = {}
